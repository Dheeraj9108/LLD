...
import SplitwiseLLD.stratergy.EqualStartergy;
import SplitwiseLLD.stratergy.ExactStartergy;
import SplitwiseLLD.stratergy.PercentageSplit;

public class SplitwiseLDMain {
    public static void main(String[] args) {
        ...
        service.createExpense(new Expense.Builder()
                .setDescription("Dinner")
                .setAmount(1000)
                .setPaidBy(alice)
                .setUser(Arrays.asList(alice, bob, charlie, david))
                .setStratergy(new EqualStartergy()));
        ...
        service.createExpense(new Expense.Builder()
                ...
                .setAmount(370)
                .setPaidBy(alice)
                .setUser(Arrays.asList(bob, charlie))
                .setStratergy(new ExactStartergy())
                .setAmount(Arrays.asList(120.0, 250.0)));
        ...
        service.createExpense(new Expense.Builder()
                ...
                .setAmount(500)
                .setPaidBy(david)
                .setUser(Arrays.asList(alice, bob, charlie))
                .setStratergy(new PercentageSplit())
                .setAmount(Arrays.asList(40.0, 30.0, 30.0)) // 40%, 30%, 30%
        );
