...
import CricinfoLLD.CommentaryManager;
...
public class Ball {
    ...
    private final ExtraType type; // Null if no extra
    ...
    public int getRunScored() { return runsScored; }
    public Player getPlayedBy() { return facedBy; }
